...
class RowsAjaxSubscriptions {
    ...
    _createInstance() {
        const restaurant = jQuery('#restaurant').val();
        const _this = this;
        this._datatable = jQuery("#datatable_subscriptions").DataTable({
            scrollX: true,
            ajax: "/restaurants/" + restaurant + "/subscriptions.json",
