...
<script src="/js/plugins/datatable/branches_datatable.ajax.js"></script>
@endsection
        ...
        <div class="col">
            ...
            <div class="data-table-rows slim">
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-3 col-xxl-2 mb-1">
                        <div
                            ...
                            <input class="form-control datatable-search" placeholder="Search"
                                data-datatable="#datatable_branches" />
                ...
                <div class="data-table-responsive-wrapper">
                    <table id="datatable_branches" class="data-table nowrap w-100">
                        <thead>
                            <tr>
                                ...
                                <th class="text-muted text-small text-uppercase">{{ __('City') }}</th>
