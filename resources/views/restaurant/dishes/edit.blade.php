                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-center">
                                    <div class="position-relative d-inline-block" id="dishImage">
                                        @if ($dish->image !== NULL)
                                        <img src="{{ config('app.url'). '/'. $dish->image }}" alt="alternate text" class="rounded-md border border-separator-light border-4 sw-18 sh-18" />
                                        @else
                                        <img src="{{ config('app.url'). '/img/logo/uchuva.png' }}" alt="alternate text" class="rounded-md border border-separator-light border-4 sw-18 sh-18" />
                                        @endif
