            ...
            <div class="page-title-container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                        ...
                        <a href="{{ route('restaurant.dishes.create') }}"
                    ...
                    <table DataTable="true" class="data-table nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    @if ($dish->available === 1)
                                    <i class="bi-check-circle-fill icon icon-14 text-success"></i>
                                    @else
                                    <i class="bi-x-circle-fill icon icon-14 text-danger"></i>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ route('restaurant.dishes.edit', $dish->id) }}">
                                        {{ $dish->name }}
                                    </a>
                                </td>
                                <td>{{ $dish->category->name }}</td>
                                <td>@money($dish->price)</td>
                                <td class="text-center">{{ $dish->quality }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
