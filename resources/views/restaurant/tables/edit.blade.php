...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <section class="scroll-section">
                <div class="card mb-5">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('restaurant.tables.update', $table) }}" class="tooltip-end-bottom"
                            novalidate>
                            @csrf
                            @method('PUT')
            ...
            <form action="{{ route('restaurant.tables.destroy', $table->id) }}" method="POST">
                @csrf
                @method('DELETE')

                <div class="d-flex justify-content-end">
                    <x-button type="submit" class="btn-danger">{{ __('Delete table') }}</x-button>
                </div>
