        ...
        <div class="col">
            ...
            <section class="scroll-section" id="title">
                <div class="page-title-container">
                    <h1 class="mb-0 pb-0 display-4">{{ $title .' | '. __('Waiter') }}</h1>
                </div>
            </section>
            <!-- Title End -->
            ...
            <section class="scroll-section">
                <div class="card mb-5">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('restaurant.waiters.update', $waiter) }}" class="tooltip-end-bottom"
                                ...
                                <div class="col">
                                    <div class="col-12 col-xl-12 col-xxl-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <x-input disabled id="email" name="email" value="{{ $waiter->user->email }}" required />
                                        </div>
