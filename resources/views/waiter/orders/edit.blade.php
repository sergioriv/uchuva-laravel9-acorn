                                                            ...
                                                            @foreach ($category->dishes as $dish)
                                                                ...
                                                                @if ($dish->available != null || $dish_quality > 0)
                                                                    <tr>
                                                                        <td>
                                                                            <text
                                                                                class="h6">{{ $dish->quality }}</text>
                                                                            <br>
                                                                            <text class="h4"
                                                                                id="dish-name-{{ $dish->id }}">{{ $dish->name }}</text>
                                                                            <br>
                                                                            ...
                                                                            <div id="note-{{ $dish->id }}"
                                                                                ...
                                                                                <textarea name="dish-note-{{ $dish->id }}" id="dish-note-{{ $dish->id }}" class="form-control" rows="2"
                                                                                    placeholder="{{ __('add note') }}">{{ $dish_note }}</textarea>
                                                                            </div>
                                                                            <input type="hidden"
                                                                                name="dish-price-{{ $dish->id }}"
                                                                                value="{{ $dish->price }}">
                                                                        </td>
                                                                    </tr>
                                                                @endif
