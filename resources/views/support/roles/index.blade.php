...
<script src="/js/plugins/datatable/roles_datatable.ajax.js"></script>
@endsection
            ...
            <div class="page-title-container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                        ...
                        <a href="{{ route('support.roles.create') }}"
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-3 col-xxl-2 mb-1">
                        <div
                            ...
                            <input class="form-control datatable-search" placeholder="Search"
                                data-datatable="#datatable_roles" />
                    ...
                    <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                        <div class="d-inline-block">
                            ...
                            {{-- <div class="dropdown-as-select d-inline-block datatable-length"
                                data-datatable="#datatable_roles" data-childSelector="span">
