...
<script src="/js/plugins/datatable/waiters_datatable.ajax.js"></script>
@endsection
        ...
        <div class="col">
            ...
            <div class="page-title-container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                        ...
                        <a href="{{ route('branch.waiters.create') }}"
            ...
            <div class="data-table-rows slim">
                ...
                <div class="data-table-responsive-wrapper">
                    <table id="datatable_waiters" class="data-table nowrap w-100">
                        <thead>
                            <tr>
